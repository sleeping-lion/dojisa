 ...
 **/ 
function remove_image(ID) { var img = "#slide-img"+ID;
var text = "#weblizar_inpute"+ID;
var preview = "#slide-img"+ID;
var remove = "#remove_button"+ID;
jQuery(text).val('');
jQuery(preview).hide(200);
jQuery(remove).hide(200);
...
var img = "#slide-img"+ID;
var text = "#weblizar_inpute"+ID;
var preview = "#slide-img"+ID;
var no_media = "#no_slide_media"+ID;
var src_url = jQuery(text).val();
if(src_url==""){
jQuery(no_media).fadeIn(2000);
jQuery(no_media).fadeOut(2000);
jQuery(preview).hide(200);

}
else{
jQuery(preview).attr("src",src_url).toggle(500);
}
