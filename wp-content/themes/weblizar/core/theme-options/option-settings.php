...
<div class="block ui-tabs-panel deactive" id="option-site-info" >
	<form method="post" id="weblizar_theme_options_site-info">
		...
		<div class="section">
			<h3><?php _e('Show Home Blog Post','weblizar'); ?></h3>
			<?php $blog_count= $wl_theme_options['blog_count'];		
			?>
			<select name="blog_count" class="wl_inpute">
					<option <?php echo selected($blog_count, '3' ); ?> value="3" >3</option>
					<option <?php echo selected($blog_count, '6' ); ?> value="6" >6</option>
					<option <?php echo selected($blog_count, '9' ); ?> value="9" >9</option>
					<option <?php echo selected($blog_count, '12' ); ?> value="12" >12</option>
					<option <?php echo selected($blog_count, '15' ); ?> value="15" >15</option>
					<option <?php echo selected($blog_count, $published_posts ); ?> value="<?php echo $published_posts; ?>" >Show All Posts</option>
			</select>
		</div>
		<div class="section">
...
<div class="block ui-tabs-panel deactive" id="option-home-service" >
	<form method="post" id="weblizar_theme_options_home-service">
		...
		<div class="section">
			<h3><?php _e('Show Service ON Home','weblizar'); ?></h3>
			<input type="checkbox" <?php if($wl_theme_options['service_enable']=='on') echo "checked='checked'"; ?> id="service_enable" name="service_enable" > <span class="explain"><?php _e('Show Services on Home','weblizar');?>.</span>
		</div>
