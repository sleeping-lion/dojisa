		...
		<div class="wbl-notify" id="wbl-notify">
			<div class="col-md-12">
				<div class="col-md-2 col-sm-6">
					...
					<a style="margin-bottom:20px" href="http://weblizar.com/themes/weblizar-premium-theme/" target="blank" class="btn btn-success btn-lg"><?php _e('View Weblizar Pro Demo','weblizar'); ?> </a>
