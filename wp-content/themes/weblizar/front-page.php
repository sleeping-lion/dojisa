...
<div class="content-wrapper">    
	<div class="body-wrapper">
		...
		<?php if($wl_theme_options['service_enable'] == 'on') { ?>
			...
			<div class="row">
				...
				<div class="col-md-3 col-sm-3">
					<div class="content-box content-style2 anim-opacity animated fadeIn animatedVisi" data-animtype="fadeIn" data-animrepeat="0" data-animspeed="1s" data-animdelay="0.2s" style="-webkit-animation: 1s 0.2s;">	
						...
						<?php } ?>
						<div class="content-box-text">
							<?php if($wl_theme_options['service_2_text']) { echo apply_filters('the_content', $wl_theme_options['service_2_text'], true); } ?>
				...
				<div class="col-md-3 col-sm-3">
					<div class="content-box content-style2 anim-opacity animated fadeIn animatedVisi" data-animtype="fadeIn" data-animrepeat="0" data-animspeed="1s" data-animdelay="0.2s" style="-webkit-animation: 1s 0.2s;">	
						...
						<?php } ?>
						<div class="content-box-text">
							<?php if($wl_theme_options['service_3_text']) { echo apply_filters('the_content', $wl_theme_options['service_3_text'], true); } ?>
				...
				<div class="col-md-3 col-sm-3">
					<div class="content-box content-style2 anim-opacity animated fadeIn animatedVisi" data-animtype="fadeIn" data-animrepeat="0" data-animspeed="1s" data-animdelay="0.2s" style="-webkit-animation: 1s 0.2s;">	
						...
						<?php } ?>
						<div class="content-box-text">
							<?php if($wl_theme_options['service_4_text']) { echo apply_filters('the_content', $wl_theme_options['service_4_text'], true); } ?>
		...
		<div class="container">
			...
			<?php
				...
				global $more;	$more = 0; ?>							
				<div class="col-md-4 col-sm-4" id="row-<?php echo $i; ?>">
