		...
		<div class="row">
			...
			<div class="col-xs-5 col-md-6">
				<ul class="social_link col-xs-12 col-sm-6 col-lg-4">
					...
					<li><a href="https://www.facebook.com/NamKyungpil" class="facebook_link" title="새창에서 열림(도지사 남경필 Facebook)" target="_blank"><span class="point">F</span><span>ace Book</span></a></li>
				</ul>		
				<ul id="home_sitemap_link" class="hidden-xs col-sm-6 col-lg-4">
